...
def generate_distribution_pit():
    ...
    for tax_type in tax_list:
        ...
        text_output1 = df_str + '\n\n' + df_reform_str + '\n\n'
        l = tk.Button(window_dict[tax_type],text="Save Results",command=lambda: write_file(df[tax_type], text_output1, filename1, window_dict[tax_type], row_num[tax_type]))
