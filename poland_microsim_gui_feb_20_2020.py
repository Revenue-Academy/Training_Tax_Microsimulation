...
class Application(Frame):
    def __init__(self, master=None):
        ...
        self.data_filename = "cit_poland.csv"
        self.weights_filename = "cit_weights_poland1.csv"
        self.policy_filename = "current_law_policy_poland.json"
        self.growfactors_filename = "current_law_policy_poland.json"        
        ...
        self.root_title=Label(text="Poland Tax Microsimulation Model",
    ...
    def generate_total_revenues(self):
        ...
        total_revenue_text = "TAX COLLECTION FOR THE YEAR - " + str(self.selected_year)+" : "+str(citax_collection_str1)+" bill Zlotys"
    ...
    def apply_policy_change(self):
        ...
        for year in range(2019, 2024):  
            ...
            total_revenue_text[year] = "TAX COLLECTION UNDER CURRENT LAW FOR THE YEAR - " + str(year)+" : "+str(citax_collection_str1)+" bill Zlotys"
            ...
            reform_revenue_text[year] = "TAX COLLECTION UNDER REFORM FOR THE YEAR - " + str(year)+"           : "+str(citax_collection_str2)+" bill Zlotys"
    ...
    def generate_tax_expenditures(self):
        ...
        for year in range(2019, 2024):  
            ...
            reform_revenue_text[year] = "TAX COLLECTION UNDER BENCHMARK FOR THE YEAR - " + str(year)+" : "+str(citax_collection_str2)+" bill Zlotys"

            tax_expenditure_text[year] = "TAX EXPENDITURES FOR THE YEAR - " + str(year)+" : "+citax_expenditure_billions_str+" bill Zlotys"
