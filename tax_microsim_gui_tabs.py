...
class Application(Frame):
    def __init__(self, master=None):
        ...
        TAB_CONTROL.add(self.TAB1, text='Main Page')
        #Tab2
        ...
        self.growfactors_filename = "taxcalc/growfactors1.csv"      
        ...
        self.root_title=Label(self.TAB1,text="Tax Microsimulation Model",
        ...
        """        
        self.l1A=Label(self.TAB1, text="Current Law",
                 font = self.fontStyle_sub_title)
        self.l1A.place(relx = self.block_1_title_pos_x, rely = self.block_1A_title_pos_y, anchor = "w")
        #(...)
        #action_with_arg = partial(action, arg)
        #button = Tk.Button(master=frame, text='press', command=action_with_arg)
        self.button_generate_revenue_curr_law = ttk.Button(self.TAB1, text = "Generate Current Law Total Revenues", style='my.TButton', command=self.generate_total_revenues)
        self.button_generate_revenue_curr_law.place(relx = self.button_1_pos_x, 
                                                 rely = self.button_1_pos_y, anchor = "w")
        
        self.l2=Label(self.TAB1, text="Reform", font = self.fontStyle_sub_title)
        self.l2.place(relx = self.block_1_title_pos_x, rely = self.block_2_title_pos_y, anchor = "w")
        
        self.l3=Label(self.TAB1, text="Select Policy Parameter: ", font = self.fontStyle)
        ...
        self.block_widget_dict[1][1] = ttk.Combobox(self.TAB1, value=self.policy_options_list, font=self.text_font, name=str(self.num_reforms))
        ...
        self.l4=Label(self.TAB1,text="Year: ", font = self.fontStyle)
        self.l4.place(relx = self.block_2_entry_1_2_x, 
                 rely = self.block_2_entry_1_1_y-self.text_entry_gap, anchor = "w")
        self.block_widget_dict[1][2] = Entry(self.TAB1, width=6, font = self.fontStyle)
        self.block_widget_dict[1][2].place(relx = self.block_2_entry_1_2_x, rely = self.block_2_entry_1_1_y, anchor = "w")
        
        self.l5=Label(self.TAB1,text="Value: ", font = self.fontStyle)
        self.l5.place(relx = self.block_2_entry_1_3_x, 
                 rely = self.block_2_entry_1_1_y-self.text_entry_gap, anchor = "w")
        self.block_widget_dict[1][3] = Entry(self.TAB1, width=10, font = self.fontStyle)
        self.block_widget_dict[1][3].place(relx = self.block_2_entry_1_3_x, rely = self.block_2_entry_1_1_y, anchor = "w")
        
        self.num_reforms += 1
        self.button_add_reform = ttk.Button(self.TAB1, text="+", style='my.TButton', command=self.create_policy_widgets, width=2)
        self.button_add_reform.place(relx = self.button_add_reform_x, rely = self.block_2_entry_1_1_y, anchor = "w")        
        
        self.button_generate_revenue_policy = ttk.Button(self.TAB1, text = "Generate Revenue under Reform", style='my.TButton', command=self.apply_policy_change)
        ...
        self.l3A=Label(self.TAB1,text="Tax Expenditures",
                 font = self.fontStyle_sub_title)
        self.l3A.place(relx = self.block_3_title_pos_x, rely = self.block_3_title_pos_y, anchor = "w")

        self.entry_benchmark_filename = Entry(self.TAB1, width=30, font = self.fontStyle)
        ...
        self.button_benchmark_filename = ttk.Button(self.TAB1, text = "Change Benchmark File", style='my.TButton', command=self.input_benchmark_filename)
        self.button_benchmark_filename.place(relx = self.block_3_entry_x,
                                   rely = self.block_3_entry_y, anchor = "w")        
        self.button_generate_tax_expenditures = ttk.Button(self.TAB1, text = "Generate Tax Expenditures", style='my.TButton', command=self.generate_tax_expenditures)
        ...
        self.pic = tk.Label(self.TAB1,image=self.image)
    ...
    def create_policy_widgets(self):
        ...
        self.block_widget_dict[self.num_reforms][1] = ttk.Combobox(self.TAB1, value=self.policy_options_list, font=self.text_font, name=str(self.num_reforms))
        ...
        self.block_widget_dict[self.num_reforms][2] = Entry(self.TAB1, width=6, font=self.fontStyle)
        ...
        self.block_widget_dict[self.num_reforms][3] = Entry(self.TAB1, width=14, font=self.fontStyle)
    ...
    def generate_total_revenues(self):
        ...
        ax.set_yLabel(self.TAB1,'CIT in million ')
        ax.set_xLabel(self.TAB1,'')
    ...
    def apply_policy_change(self):
        ...
        window = tk.Toplevel()
        window.geometry("600x500+140+140")
        label = Label(window, text="Results", font=self.fontStyle)
        ...
        for year in range(2019, 2024):  
            ...
            #self.l6=Label(self.TAB1,text=self.total_revenue_text1)
            ...
            #self.l7=Label(self.TAB1,text=self.reform_revenue_text1)
...
"""
    ...
    #Button(self.TAB1, row=6, column=1, sticky = W, pady = (0,25), padx = (0,0))
    root.mainloop()
