...
def tab7(self):   
    ...
    self.tab_growfactors = super_combo(self.TAB7, self.growfactors, 'Year', 'Value', 0.01, 0.20, attribute_value, self.selected_attribute_widget)
